...
const birthdayClasses: Record<string, string> = {
	today: "border-2 animate-birthday-gold",
	upcoming: "border-2 animate-birthday-purple",
};
			...
			<ContextMenuTrigger asChild>
				<button
					className={cn(
						...
						classes[_status],
						birthdayStatus && birthdayClasses[birthdayStatus],
					)}
					onClick={() => {
