...
export default function SkillsMasteryPowers() {
	...
	const masteryExp = useMemo(() => {
		...
		const currentLevelThreshold = getMasteryExpNeededForLevel(masteryLevel);
		const nextLevelExperience =
			getMasteryExpNeededForLevel(masteryLevel + 1) - currentLevelThreshold;
		const currentExperience = playerPowers - currentLevelThreshold;
												...
												{playerExperiencePoints && (
													<>
														...
														<p className="text-xs text-neutral-500 dark:text-neutral-400">
															{playerExperiencePoints.farming.percentage === 100
																? "Max level"
																: `${playerExperiencePoints.farming.experiencePointsRequired - playerExperiencePoints.farming.experiencePointsRemaining} / ${playerExperiencePoints.farming.experiencePointsRequired} XP`}
														</p>
													</>
												)}
											</InfoCard>
											...
											>
												{playerExperiencePoints && (
													<>
														...
														<p className="text-xs text-neutral-500 dark:text-neutral-400">
															{playerExperiencePoints.fishing.percentage === 100
																? "Max level"
																: `${playerExperiencePoints.fishing.experiencePointsRequired - playerExperiencePoints.fishing.experiencePointsRemaining} / ${playerExperiencePoints.fishing.experiencePointsRequired} XP`}
														</p>
													</>
												)}
											</InfoCard>
											...
											>
												{playerExperiencePoints && (
													<>
														...
														<p className="text-xs text-neutral-500 dark:text-neutral-400">
															{playerExperiencePoints.foraging.percentage === 100
																? "Max level"
																: `${playerExperiencePoints.foraging.experiencePointsRequired - playerExperiencePoints.foraging.experiencePointsRemaining} / ${playerExperiencePoints.foraging.experiencePointsRequired} XP`}
														</p>
													</>
												)}
											</InfoCard>
												...
												{playerExperiencePoints && (
													<>
														...
														<p className="text-xs text-neutral-500 dark:text-neutral-400">
															{playerExperiencePoints.mining.percentage === 100
																? "Max level"
																: `${playerExperiencePoints.mining.experiencePointsRequired - playerExperiencePoints.mining.experiencePointsRemaining} / ${playerExperiencePoints.mining.experiencePointsRequired} XP`}
														</p>
													</>
												)}
											</InfoCard>
												...
												{playerExperiencePoints && (
													<>
														...
														<p className="text-xs text-neutral-500 dark:text-neutral-400">
															{playerExperiencePoints.combat.percentage === 100
																? "Max level"
																: `${playerExperiencePoints.combat.experiencePointsRequired - playerExperiencePoints.combat.experiencePointsRemaining} / ${playerExperiencePoints.combat.experiencePointsRequired} XP`}
														</p>
													</>
												)}
											</InfoCard>
											...
											>
												...
												<>
													...
													<p className="text-xs text-neutral-500 dark:text-neutral-400">
														{masteryExp.level >= 5
															? "Max level"
															: `${masteryExp.experiencePointsRequired - masteryExp.experiencePointsRemaining} / ${masteryExp.experiencePointsRequired} XP`}
													</p>
												</>
												)}
											</InfoCard>
